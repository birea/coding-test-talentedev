<template>
  <SlideYUpTransition :duration="animationDuration">
    <div class="modal fade"
         @mousedown.self="closeMouseDown"
         @mouseup.self="closeMouseUp"
...
<script>
  ...
  export default {
    ...
    methods: {
      ...
      closeMouseDown() {
        this.wasModalBorderClicked = true;
      },
      closeMouseUp() {
        if (this.wasModalBorderClicked) {
          this.closeModal();
        }
        this.wasModalBorderClicked = false;
      },
    },
    watch: {
      show(val) {
